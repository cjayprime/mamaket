...
const Footer = () => {
    ...
    return (
        <Grid container justify="center" alignItems="center" style={{ backgroundColor: '#0177B6', color: '#FFFFFF', fontFamily: 'Quicksand', fontSize: 17, height: matchesXS ? 1500 : 500, marginTop: 50 }}>
